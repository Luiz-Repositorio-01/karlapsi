...
import { AgendamentoMotionLayout } from '@/components/site/AgendamentoMotionLayout';
  ...
  return (
    <>
      ...
      <Section tone="default">
        <Container>
          <AgendamentoMotionLayout
            wizard={
              <>
                {!supabaseReady ? (
                  <Alert tone="warning" title="Agenda em modo de demonstração" className="mb-8">
            ...
            asideItems={[
              ...
              ...(settings.contact.whatsapp
                ? [
                    <Card key="whatsapp" className="bg-surface-muted">
